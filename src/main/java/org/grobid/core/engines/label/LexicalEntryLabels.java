...
public class LexicalEntryLabels extends TaggingLabels {
    ...
    public static final String LEXICAL_ENTRY_SYNONYM_LABEL = "<synonym>";
    public static final String LEXICAL_ENTRY_ANTONYM_LABEL = "<antonym>";
    public static final String LEXICAL_ENTRY_NUM_LABEL = "<num>";
    public static final String LEXICAL_ENTRY_NOTE_LABEL = "<note>";
    public static final String LEXICAL_ENTRY_GRAMGRP_LABEL = "<gramGrp>";
