...
public class DictionaryBodySegmentationLabels extends TaggingLabels {
    ...
    public static final String DICTIONARY_SECTION_LABEL = "<section>";
    ...
    public static final TaggingLabel DICTIONARY_BODY_SECTION = new TaggingLabelImpl(DictionaryModels.DICTIONARY_BODY_SEGMENTATION, DICTIONARY_SECTION_LABEL);
    ...
    static {
        ...
        register(DICTIONARY_BODY_SECTION);
    }
}
