...
public class DictionaryModels {
    ...
    public static final GrobidModel SUB_ENTRY = GrobidDictionaryModels.modelFor("sub-entry");
    public static final GrobidModel DIVISION = GrobidDictionaryModels.modelFor("division");
