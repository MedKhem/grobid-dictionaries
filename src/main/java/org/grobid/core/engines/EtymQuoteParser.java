...
public class EtymQuoteParser  extends AbstractParser {
    ...
    public void createTrainingtoEtymQuote(File path, String outputDirectory, Boolean isAnnotated) throws Exception {
        ...
        File existingCssFile = new File("resources/templates/etymQuote.css");
...
//        Files.copy(Gui.getClass().getResourceAsStream("resources/templates/lexicalEntry.css"), Paths.get("new_project","css","lexicalEntry.css"))
        ...
        // write the TEI file
        String outTei = outputDirectory + "/" + path.getName().substring(0, path.getName().length() - 4) + ".training.etymQuote.tei.xml";
