...
//            accumulator.append(" ");
    ...
    private boolean isRelevantTag(String qName) {
        if ("lemma".equals(qName) || "prefix".equals(qName) || "suffix".equals(qName)
                || "def".equals(qName)  ||  (qName.equals("gloss"))
                || "xr".equals(qName) || "pc".equals(qName) || "dictScrap".equals(qName)) {
            return true;
        }
        return false;
    }
