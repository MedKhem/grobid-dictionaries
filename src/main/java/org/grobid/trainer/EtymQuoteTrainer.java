...
import org.grobid.trainer.sax.TEIEtymQuoteSaxParser;
...
public class EtymQuoteTrainer extends AbstractDictionaryTrainer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractDictionaryTrainer trainer = new EtymQuoteTrainer();
    ...
    public int addFeaturesLexicalEntries(String sourceTEIPathLabel,
        ...
        try {
            ...
            for (File tf : refFiles) {
                ...
                TEIEtymQuoteSaxParser parser2 = new TEIEtymQuoteSaxParser();
