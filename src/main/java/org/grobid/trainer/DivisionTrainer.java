...
import org.grobid.trainer.sax.TEIDivisionSaxParser;
...
public class DivisionTrainer  extends AbstractDictionaryTrainer {

    public DivisionTrainer() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractDictionaryTrainer trainer = new DivisionTrainer();
    ...
    public int createCRFPPData(File corpusPath, File outputFile) {
        return addFeaturesDivisions(corpusPath.getAbsolutePath() + "/tei", corpusPath + "/raw", outputFile);
    }
     ...
     * @param sourceDivisionsPathFeatures path to fulltexts
     * @param outputPath                       output train file
     * @return number of examples
     */
    public int addFeaturesDivisions(String sourceTEIPathLabel,
                                    String sourceDivisionsPathFeatures,
                                    File outputPath) {
        int totalExamples = 0;
        ...
        try {
            ...
            System.out.println("sourceLexicalEntriesPathFeatures: " + sourceDivisionsPathFeatures);
            ...
            for (File tf : refFiles) {
                ...
                TEIDivisionSaxParser parser2 = new TEIDivisionSaxParser();
                ...
                BufferedReader featuresFile = new BufferedReader(
                        new InputStreamReader(new FileInputStream(sourceDivisionsPathFeatures + File.separator +
