...
import org.grobid.trainer.sax.TEIRelatedEntrySaxParser;
...
public class RelatedEntryTrainer extends AbstractDictionaryTrainer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractDictionaryTrainer trainer = new RelatedEntryTrainer();
    ...
    public int addFeaturesForm(String sourcePathLabels,
        ...
        try {
            ...
            for (File tf : refFiles) {
                ...
                TEIRelatedEntrySaxParser parser2 = new TEIRelatedEntrySaxParser();
